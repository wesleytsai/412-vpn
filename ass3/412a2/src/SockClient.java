...
public class SockClient {
    ...
    public void connectToServer() throws IOException {
        ...
        int serverPort = Integer.parseInt((String) JOptionPane.showInputDialog(frame, "Enter Server Port to Use", serverAddress, JOptionPane.INFORMATION_MESSAGE,null, null, "" ));
